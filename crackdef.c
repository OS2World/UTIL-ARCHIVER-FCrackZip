...
method methods[] = {
  ...
  { "zip1, TARGET_CPU=5", METHOD1_init_crack_pw, METHOD1_crack_pw, load_zip },
  { "zip2, TARGET_CPU=5, USE_MULT_TAB", METHOD2_init_crack_pw, METHOD2_crack_pw, load_zip },
  { "zip3, TARGET_CPU=6", METHOD3_init_crack_pw, METHOD3_crack_pw, load_zip },
  { "zip4, TARGET_CPU=6, USE_MULT_TAB", METHOD4_init_crack_pw, METHOD4_crack_pw, load_zip },
#elif 1
  { "cpmask", init_cpmask, crack_cpmask, load_img },
